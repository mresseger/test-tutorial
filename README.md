...
3. Clone the repository locally. Open Github for Desktop and click "Clone the repository". Follow the prompts to paste the repo html. ![clone repo](https://github.com/bpda-research-division/test-tutorial/blob/main/tutorial_images/clone_repo.png) <br> <br>. Paste the repo url into the box in Github for desktop
